...
extra_sans="IP:127.0.1.1,IP:${service_cluster_ip_range%.*}.1,DNS:kubernetes,DNS:kubernetes.default,DNS:kubernetes.default.svc,DNS:kubernetes.default.svc.cluster.local"
cert_dir=${CERT_DIR:-~/tmp/srv/kubernetes}
